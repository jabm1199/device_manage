...
<%--			<li role="presentation"><a href="01main.jsp" target="view_frame"><span class="glyphicon glyphicon-picture" aria-hidden="true">&nbsp;首页</span></a></li>--%>
			<li role="presentation"><a href="05device.jsp" target="view_frame"><span class="glyphicon glyphicon-search" aria-hidden="true">&nbsp;设备查询</span></a></li>
...
<%--			<li role="presentation"><a href="06borrow.jsp" target="view_frame"><span class="glyphicon glyphicon-book" aria-hidden="true">&nbsp;使用信息</span></a></li>--%>
