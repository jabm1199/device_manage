/*
 ...
 Source Server         : auto_test_server
...
CREATE TABLE `borrow_card`  (
  ...
  `status` smallint NULL DEFAULT NULL COMMENT '0注销，1正常',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of device
-- ----------------------------
INSERT INTO `device` VALUES (1, 'RK3399', '软测01', '192.168.1.101', 'firefly', 'firefly', NULL);
INSERT INTO `device` VALUES (2, 'RK3399', '软测02', '192.168.1.135', 'firefly', 'firefly', NULL);
INSERT INTO `device` VALUES (3, 'RK3399', '软测03', '192.168.1.132', 'firefly', 'firefly', NULL);
INSERT INTO `device` VALUES (4, 'RK3399', '软测04', '192.168.1.120', 'firefly', 'firefly', NULL);
INSERT INTO `device` VALUES (5, 'RK3399', '软测05', '192.168.1.127', 'firefly', 'firefly', NULL);
INSERT INTO `device` VALUES (6, 'RK3399', '软测06', '192.168.1.138', 'firefly', 'firefly', NULL);
INSERT INTO `device` VALUES (7, 'RK3399', '软测07', '192.168.1.117', 'firefly', 'firefly', NULL);
...
CREATE TABLE `device_status`  (
  ...
  `device_ip` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `online_status` smallint NULL DEFAULT NULL,
  `occupy_status` smallint NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `device_status` VALUES (1, '192.168.1.101', 1, 0);
INSERT INTO `device_status` VALUES (2, '192.168.1.135', 1, 0);
INSERT INTO `device_status` VALUES (3, '192.168.1.132', 1, 0);
INSERT INTO `device_status` VALUES (4, '192.168.1.120', 1, 0);
INSERT INTO `device_status` VALUES (5, '192.168.1.127', 1, 0);
INSERT INTO `device_status` VALUES (6, '192.168.1.138', 0, 0);
INSERT INTO `device_status` VALUES (7, '192.168.1.117', 0, 0);
...
CREATE TABLE `rules`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `borrow_num` int NULL DEFAULT NULL COMMENT '限制本数',
  `limit_day` int NULL DEFAULT NULL COMMENT '限制天数',
